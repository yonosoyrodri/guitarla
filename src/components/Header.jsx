												...
												{cart.map((guitarra) => (
													<tr key={guitarra.id}>
														...
														<td className="flex align-items-start gap-4">
															<button type="button" className="btn btn-dark" onClick={() => decreaseQuantity(guitarra.id)}>
																-
															</button>
															{guitarra.quantity}
															<button type="button" className="btn btn-dark" onClick={() => increaseQuantity(guitarra.id) }>
																+
															</button>
														</td>
														<td>
															<button className="btn btn-danger" type="button" onClick={() => removeFromCart(guitarra.id)}>
																X
															</button>
														</td>
													</tr>
